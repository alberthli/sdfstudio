...
from sdfstudio.data.dataparsers.sdfstudio_dataparser import SdfStudioDataParserConfig
from sdfstudio.engine.optimizers import AdamOptimizerConfig, RAdamOptimizerConfig, AdamWOptimizerConfig
...
from sdfstudio.models.instant_ngp import InstantNGPModelConfig
...
from sdfstudio.models.vanilla_sdf import SDFModel, VanillaModelConfig
...
descriptions = {
    ...
    "vanilla-sdf": "Original SDF model. (slow)",
...
method_configs["instant-ngp"] = Config(
    ...
    pipeline=DynamicBatchPipelineConfig(
        datamanager=VanillaDataManagerConfig(dataparser=SdfStudioDataParserConfig(), train_num_rays_per_batch=8192),
...
method_configs["mipnerf"] = Config(
    method_name="mipnerf",
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(dataparser=SdfStudioDataParserConfig(), train_num_rays_per_batch=1024),
...
method_configs["vanilla-sdf"] = Config(
    method_name="vanilla-sdf",
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=BlenderDataParserConfig(),
        ),
        model=VanillaModelConfig(_target=SDFModel),
    ),
    optimizers={
        "fields": {
            "optimizer": RAdamOptimizerConfig(lr=5e-4, eps=1e-08),
...
method_configs["dnerf"] = Config(
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=VanillaModelConfig(
            ...
            temporal_distortion_params={"kind": TemporalDistortionKind.DSDF},
        ),
    ),
    optimizers={
        "fields": {
