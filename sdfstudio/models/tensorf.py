...
from sdfstudio.field_components.encodings import SDFEncoding, TensorVMEncoding
...
class TensoRFModel(Model):
    ...
    def populate_modules(self):
        ...
        feature_encoding = SDFEncoding(in_dim=self.appearance_dim, num_frequencies=2, min_freq_exp=0, max_freq_exp=2)
        direction_encoding = SDFEncoding(in_dim=3, num_frequencies=2, min_freq_exp=0, max_freq_exp=2)
